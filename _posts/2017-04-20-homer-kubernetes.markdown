...
That's a short list, right? Well... Installing Kubernetes isn't that hard (and I've got the [ansible playbooks to do it](https://github.com/redhat-nfvpe/kube-ansible)). But, we also need to have some persistent storage to use.
