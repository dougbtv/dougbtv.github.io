...
If you don't have a Kubernetes cluster up, may I recommend using my [kube-ansible](https://github.com/redhat-nfvpe/kube-ansible) playbooks -- and I've got an article [detailing how to use those playbooks](http://dougbtv.com/nfvpe/2017/02/16/kubernetes-1.5-centos/).
