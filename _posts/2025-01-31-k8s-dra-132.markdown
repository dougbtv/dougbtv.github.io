...
author: dougbtv
comments: true
date: 2025-01-31 09:02:00-05:00
layout: post
slug: k8s-dra-132
...
I've noticed that some cloud providers contributing to Kubernetes replace the kubelet entirely with proprietary downstream solutions. While I get why they do it, it creates a disconnect between how Kubernetes is developed upstream and how users experience it in the real world. Our designs should prioritize the community’s needs first, not just cloud operator convenience.
